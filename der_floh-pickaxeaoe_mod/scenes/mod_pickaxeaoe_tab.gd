...
# Dynamically built settings tab for the Pickaxe AOE mod.
# Instantiated and added to SettingsMenu.tab_container by settings_2.hooks.gd.

const LOG_NAME := "der_floh-pickaxeaoe_mod:Tab"
...
func _ready() -> void:
	var mod_main = load("res://mods-unpacked/der_floh-pickaxeaoe_mod/mod_main.gd")
	...
	debug_bool.setting_label.text = "Debug Logging (prints mine_action branch info to modloader.log)"
